...
var osc = osc || {},
  osc =
    (!(function () {
      ...
      (osc.SECS_70YRS = 2208988800),
        ...
        (osc.isCommonJS = !('undefined' == typeof module || !module.exports)),
        (osc.isNode = osc.isCommonJS && 'undefined' == typeof window),
        (osc.isElectron = !(
        ...
        (osc.TextDecoder =
          'undefined' != typeof TextDecoder
            ...
            : 'undefined' != typeof util && (util.TextDecoder, 1)
            ? new util.TextDecoder('utf-8')
            : void 0),
        (osc.TextEncoder =
          'undefined' != typeof TextEncoder
            ? new TextEncoder('utf-8')
            : 'undefined' != typeof util && (util.TextEncoder, 1)
            ? new util.TextEncoder('utf-8')
            : void 0),
        (osc.dataView = function (e, t, r) {
          return e.buffer
            ? new DataView(e.buffer, t, r)
            : e instanceof ArrayBuffer
            ? new DataView(e, t, r)
            : new DataView(new Uint8Array(e), t, r);
        }),
        (osc.byteArray = function (e) {
          ...
          if (
            ...
            (void 0 !== t.length && 'string' != typeof t)
          )
            return new Uint8Array(t);
          throw new Error(
            "Can't wrap a non-array-like object as Uint8Array. Object was: " +
              JSON.stringify(e, null, 2),
          );
        }),
        (osc.nativeBuffer = function (e) {
          return osc.isBufferEnv
            ? osc.isBuffer(e)
              ? e
              : Buffer.from(e.buffer ? e : new Uint8Array(e))
            : osc.isTypedArrayView(e)
            ? e
            : new Uint8Array(e);
        }),
        (osc.copyByteArray = function (e, t, r) {
          if (osc.isTypedArrayView(e) && osc.isTypedArrayView(t)) t.set(e, r);
          else
            for (
              var n = void 0 === r ? 0 : r,
                i = Math.min(t.length - r, e.length),
                s = 0,
                o = n;
              s < i;
              s++, o++
        ...
        (osc.readString = function (e, t) {
          ...
          return (
            ...
            (osc.isBufferEnv
              ...
              : osc.readString.raw)(r)
          );
        }),
        (osc.readString.raw = function (e) {
          for (var t = '', r = 0; r < e.length; r += 1e4)
        ...
        (osc.writeString = function (e) {
          for (
            var t,
              r = osc.isBufferEnv
                ? osc.writeString.withBuffer
                : osc.TextEncoder
                ? osc.writeString.withTextEncoder
                : null,
              n = e + '\0',
              i = (r && (t = r(n)), (r ? t : n).length),
              s = new Uint8Array((i + 3) & -4),
              o = 0;
            o < i - 1;
            o++
          ) {
        ...
        (osc.writePrimitive = function (e, t, r, n, i) {
          ...
          return (
            ...
            t
              ...
              : ((s = new Uint8Array(n)), (t = new DataView(s.buffer))),
            t[r](i, e, !1),
            s
          );
        }),
        ...
        (osc.readInt64 = function (e, t) {
          var r = osc.readPrimitive(e, 'getInt32', 4, t),
        ...
        (osc.writeInt64 = function (e, t, r) {
          ...
          return (
            n.set(osc.writePrimitive(e.high, t, 'setInt32', 4, r), 0),
            n.set(osc.writePrimitive(e.low, t, 'setInt32', 4, r + 4), 4),
            n
          );
        }),
        ...
        (osc.writeChar32 = function (e, t, r) {
          e = e.charCodeAt(0);
          if (!(void 0 === e || e < -1))
            return osc.writePrimitive(e, t, 'setUint32', 4, r);
        }),
        (osc.readBlob = function (e, t) {
          var r = osc.readInt32(e, t),
            n = (r + 3) & -4,
            e = new Uint8Array(e.buffer, t.idx, r);
          return (t.idx += n), e;
        }),
        (osc.writeBlob = function (e) {
          var t = (e = osc.byteArray(e)).byteLength,
            r = new Uint8Array(4 + ((t + 3) & -4)),
        ...
        (osc.readColor = function (e, t) {
          var e = new Uint8Array(e.buffer, t.idx, 4),
            r = e[3] / 255;
          return (
            (t.idx += 4),
            {
        ...
        (osc.writeTimeTag = function (e) {
          var e = e.raw || osc.jsToNTPTime(e.native),
            t = new Uint8Array(8),
        ...
        (osc.timeTag = function (e, t) {
          e = e || 0;
          var t = (t = t || Date.now()) / 1e3,
            r = Math.floor(t),
            t = t - r,
            n = Math.floor(e),
            t = t + (e - n);
          return (
            1 < t && ((n += e = Math.floor(t)), (t = t - e)),
            {
        ...
        (osc.readArguments = function (e, t, r) {
          ...
          if (0 !== n.indexOf(','))
            throw new Error(
              'A malformed type tag string was found while reading the arguments of an OSC message. String was: ' +
                n,
              ' at offset: ' + r.idx,
            );
          var i = n.substring(1).split(''),
            s = [];
        ...
        (osc.readArgument = function (e, t, r, n, i) {
          ...
          throw new Error(
            "'" +
              e +
              "' is not a valid OSC type tag. Type tag string was: " +
              t,
          );
        }),
        (osc.readArgumentsIntoArray = function (e, t, r, n, i, s) {
          for (var o = 0; o < t.length; ) {
            ...
            if ('[' === a) {
              ...
              if (u < 0)
                throw new Error(
                  "Invalid argument type tag: an open array type tag ('[') was found without a matching close array tag ('[]'). Type tag was: " +
                    r,
                );
              (c = c.slice(0, u)),
                (c = osc.readArgumentsIntoArray([], c, r, n, i, s));
              o += u + 2;
        ...
        (osc.joinParts = function (e) {
          for (
            var t = new Uint8Array(e.byteLength), r = e.parts, n = 0, i = 0;
            i < r.length;
            i++
          ) {
            var s = r[i];
        ...
        (osc.writeArgument = function (e, t) {
          var r;
          return osc.isArray(e)
            ? osc.writeArrayArguments(e, t)
            : ((r = e.type),
              (r = osc.argumentTypes[r].writer) &&
                ((r = osc[r](e.value)), osc.addDataPart(r, t)),
              e.type);
        }),
        (osc.collectArguments = function (e, t, r) {
          osc.isArray(e) || (e = void 0 === e ? [] : [e]),
            (r = r || {
              byteLength: 0,
              parts: [],
            }),
        ...
        (osc.readMessage = function (e, t, r) {
          t = t || osc.defaults;
          var e = osc.dataView(e, e.byteOffset, e.byteLength),
            n = osc.readString(
              e,
              (r = r || {
                idx: 0,
        ...
        (osc.readMessageContents = function (e, t, r, n) {
          if (0 !== e.indexOf('/'))
            throw new Error(
              'A malformed OSC address was found while reading an OSC message. String was: ' +
                e,
            );
        ...
        (osc.collectMessageParts = function (e, t, r) {
          return (
            ...
            osc.addDataPart(osc.writeString(e.address), r),
            osc.collectArguments(e.args, t, r)
          );
        }),
        (osc.writeMessage = function (e, t) {
          if (((t = t || osc.defaults), osc.isValidMessage(e)))
            return (t = osc.collectMessageParts(e, t)), osc.joinParts(t);
          throw new Error(
            'An OSC message must contain a valid address. Message was: ' +
              JSON.stringify(e, null, 2),
          );
        }),
        ...
        (osc.collectBundlePackets = function (e, t, r) {
          (r = r || {
            ...
            osc.addDataPart(osc.writeString('#bundle'), r),
            osc.addDataPart(osc.writeTimeTag(e.timeTag), r);
          for (var n = 0; n < e.packets.length; n++) {
            var i = e.packets[n],
              i = (
                i.address ? osc.collectMessageParts : osc.collectBundlePackets
              )(i, t);
            (r.byteLength += i.byteLength),
              osc.addDataPart(osc.writeInt32(i.byteLength), r),
              (r.parts = r.parts.concat(i.parts));
          }
          return r;
        }),
        (osc.writeBundle = function (e, t) {
          if (!osc.isValidBundle(e))
            throw new Error(
              "An OSC bundle must contain 'timeTag' and 'packets' properties. Bundle was: " +
                JSON.stringify(e, null, 2),
            );
          t = t || osc.defaults;
        ...
        (osc.readBundleContents = function (e, t, r, n) {
          for (var i = osc.readTimeTag(e, r), s = []; r.idx < n; ) {
            var o = osc.readInt32(e, r),
              o = r.idx + o,
              o = osc.readPacket(e, t, r, o);
            s.push(o);
          }
          return {
            timeTag: i,
        ...
        (osc.readPacket = function (e, t, r, n) {
          ...
          throw new Error(
            "The header of an OSC packet didn't contain an OSC address or a #bundle string. Header was: " +
              i,
          );
        }),
        (osc.writePacket = function (e, t) {
          ...
          throw new Error(
            'The specified packet was not recognized as a valid OSC message or bundle. Packet was: ' +
              JSON.stringify(e, null, 2),
          );
        }),
        (osc.argumentTypes = {
          ...
          switch (typeof e) {
            ...
            case 'object':
              ...
              if (e instanceof Uint8Array || e instanceof ArrayBuffer)
                return 'b';
              if ('number' == typeof e.high && 'number' == typeof e.low)
                return 'h';
          }
          throw new Error(
            "Can't infer OSC argument type for value: " +
              JSON.stringify(e, null, 2),
          );
        }),
        (osc.annotateArguments = function (e) {
          for (var t = [], r = 0; r < e.length; r++) {
            var n = e[r];
            (n =
              'object' == typeof n && n.type && void 0 !== n.value
                ? n
                : osc.isArray(n)
                ? osc.annotateArguments(n)
                : {
          ...
          function (e, t) {
            ...
            function r(e, t) {
              ...
              return t
                ? (i = 0 <= (e >>>= 0) && e < 256) && (n = o[e])
                  ? n
                  : ((r = l(e, (0 | e) < 0 ? -1 : 0, !0)), i && (o[e] = r), r)
                : (i = -128 <= (e |= 0) && e < 128) && (n = s[e])
                ? n
                : ((r = l(e, e < 0 ? -1 : 0, !1)), i && (s[e] = r), r);
            }
            function g(e, t) {
            ...
            function u(e, t, r) {
              ...
              for (var i = g(h(r, 8)), s = m, o = 0; o < e.length; o += 8) {
                ...
                s = (a < 8 ? ((a = g(h(r, a))), s.mul(a)) : (s = s.mul(i))).add(
                  g(c),
                );
              }
            ...
            var s = {},
              ...
              h =
                ...
                (n.fromBits = l),
                Math.pow),
              i = ((n.fromString = u), (n.fromValue = p), 4294967296),
              a = i * i,
              c = a / 2,
              y = r(1 << 24),
              m = r(0),
              ...
              b = ((n.ONE = v), r(1, !0)),
              E = ((n.UONE = b), r(-1)),
              S = ((n.NEG_ONE = E), l(-1, 2147483647, !1)),
              A = ((n.MAX_VALUE = S), l(-1, -1, !0)),
              B = ((n.MAX_UNSIGNED_VALUE = A), l(0, -2147483648, !1)),
              P = ((n.MIN_VALUE = B), n.prototype);
            (P.toInt = function () {
              ...
              (P.toString = function (e) {
                ...
                if (this.isNegative())
                  return this.eq(B)
                    ? ((r = g(e)),
                      (r = (t = this.div(r)).mul(r).sub(this)),
                      t.toString(e) + r.toInt().toString(e))
                    : '-' + this.neg().toString(e);
                for (var n = g(h(e, 6), this.unsigned), i = this, s = ''; ; ) {
                  var o = i.div(n),
                    a = (i.sub(o.mul(n)).toInt() >>> 0).toString(e);
              ...
              (P.add = function (e) {
                ...
                return (
                  (u +=
                    (h = h + ((f += i + (65535 & e.low)) >>> 16) + (n + a)) >>>
                    16),
                  l(
                    ((h &= 65535) << 16) | (f &= 65535),
                    ((((c += (u += r + o) >>> 16) + (t + s)) & 65535) << 16) |
                      (u &= 65535),
                    this.unsigned,
                  )
                );
              ...
              (P.multiply = function (e) {
                ...
                return this.isZero()
                  ...
                  : (d(e) || (e = p(e)),
                    w
                      ? l(
                          w.mul(this.low, this.high, e.low, e.high),
                          w.get_high(),
                          this.unsigned,
                        )
                      : e.isZero()
                      ...
                      ? this.mul(e.neg()).neg()
                      : this.lt(y) && e.lt(y)
                      ? g(this.toNumber() * e.toNumber(), this.unsigned)
                      : ((t = this.high >>> 16),
                        (r = 65535 & this.high),
                        (n = this.low >>> 16),
                        (i = 65535 & this.low),
              ...
              (P.divide = function (e) {
                ...
                if (this.unsigned) {
                  ...
                  if (this.eq(B))
                    return e.eq(v) || e.eq(E)
                      ? B
                      : e.eq(B)
                      ? v
                      : (n = this.shr(1).div(e).shl(1)).eq(m)
                      ? e.isNegative()
                        ? v
                        : E
                      : ((t = this.sub(e.mul(n))), n.add(t.div(e)));
                ...
                for (t = this; t.gte(e); ) {
                  for (
                    var n = Math.max(
                        1,
                        Math.floor(t.toNumber() / e.toNumber()),
                      ),
                      i = Math.ceil(Math.log(n) / Math.LN2),
                      s = i <= 48 ? 1 : h(2, i - 48),
                      o = g(n),
                      a = o.mul(e);
                    a.isNegative() || a.gt(t);
      ...
      var o = e,
        e =
          ...
          (o.encode = function (e, t) {
            ...
            var t =
                ((e = o.byteArray(e, t.offset, t.byteLength)).length +
                  t.bufferPadding +
                  3) &
                -4,
              r = new Uint8Array(t),
            ...
            for (var i = 0; i < e.length; i++) {
              ...
              var s = e[i];
              s === o.END
                ? ((r[n++] = o.ESC), (s = o.ESC_END))
                : s === o.ESC && ((r[n++] = o.ESC), (s = o.ESC_ESC)),
                (r[n++] = s);
            }
          ...
          (o.Decoder = function (e) {
            (this.maxMessageSize =
              ...
              (this.bufferSize = e.bufferSize || 1024),
      ...
      return (
        (e.decode = function (e) {
          ...
          for (var r = 0; r < e.length; r++) {
            var n = e[r];
            if (this.escape)
              n === o.ESC_ESC ? (n = o.ESC) : n === o.ESC_END && (n = o.END);
            else {
              if (n === o.ESC) {
                this.escape = !0;
                continue;
        ...
        (e.addByte = function (e) {
          return (
            this.msgBufferIdx > this.msgBuffer.length - 1 &&
              (this.msgBuffer = o.expandByteArray(this.msgBuffer)),
            (this.msgBuffer[this.msgBufferIdx++] = e),
            (this.escape = !1),
            this.msgBuffer.length < this.maxMessageSize
          );
        }),
        (e.handleEnd = function () {
          ...
          if (0 !== this.msgBufferIdx)
            return (
              (e = o.sliceByteArray(this.msgBuffer, 0, this.msgBufferIdx)),
    ...
    !(function (e) {
      ...
      (r.getListeners = function (e) {
        ...
        (r.removeListener = function (e, t) {
          ...
          for (n in i)
            i.hasOwnProperty(n) && -1 !== (r = s(i[n], t)) && i[n].splice(r, 1);
          return this;
        }),
        ...
        (r.manipulateListeners = function (e, t, r) {
          ...
          if ('object' != typeof t || t instanceof RegExp)
            ...
            for (n in t)
              t.hasOwnProperty(n) &&
                (i = t[n]) &&
                ('function' == typeof i ? s : o).call(this, n, i);
          return this;
        }),
        ...
        (r.emitEvent = function (e, t) {
          ...
          for (s in o)
            if (o.hasOwnProperty(s))
              for (r = o[s].slice(0), i = 0; i < r.length; i++)
                !0 === (n = r[i]).once && this.removeListener(e, n.listener),
                  n.listener.apply(this, t || []) ===
                    this._getOnceReturnValue() &&
                    this.removeListener(e, n.listener);
          return this;
        }),
        (r.object = i('emitEvent')),
        (r.emit = function (e) {
  ...
  osc =
    (!(function () {
      'use strict';
      (osc.supportsSerial = !1),
        (osc.firePacketEvents = function (e, t, r, n) {
          t.address
            ? e.emit('message', t, r, n)
            : osc.fireBundleEvents(e, t, r, n);
        }),
      ...
      (e.constructor = osc.Port),
        (e.send = function (e) {
          var t = Array.prototype.slice.call(arguments),
            e = this.encodeOSC(e),
            e = osc.nativeBuffer(e);
        ...
        ((e = osc.SLIPPort.prototype =
          Object.create(osc.Port.prototype)).constructor = osc.SLIPPort),
        (e.encodeOSC = function (e) {
          e = e.buffer || e;
          try {
            var t = osc.writePacket(e, this.options),
              r = slip.encode(t);
          } catch (e) {
            this.emit('error', e);
          }
        ...
        (osc.Relay = function (e, t, r) {
          ((this.options = r || {}).raw = !1),
            (this.port1 = e),
            (this.port2 = t),
            this.listen();
        }),
        ((e = osc.Relay.prototype =
          Object.create(EventEmitter.prototype)).constructor = osc.Relay),
        (e.open = function () {
          this.port1.open(), this.port2.open();
        }),
        (e.listen = function () {
          this.port1Spec && this.port2Spec && this.close(),
            (this.port1Spec = osc.relayPorts(
              this.port1,
              this.port2,
              this.options,
            )),
            (this.port2Spec = osc.relayPorts(
              this.port2,
              this.port1,
              this.options,
            ));
...
!(function () {
  ...
  (e.constructor = osc.WebSocketPort),
    (e.open = function () {
